...
namespace APIVerve.API.NumbertoWords
{
    ...
    /// <summary>
    /// Client for the NumbertoWords API
    /// </summary>
    public class NumbertoWordsAPIClient
#if !NET20 && !NET35 && !NET40
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/numbertowords";
        ...
        {
            { "number", new ValidationRule { Type = "number", Required = true } }
        };
        ...
        public NumbertoWordsAPIClient(string apiKey)
#if !NET20 && !NET35 && !NET40
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public NumbertoWordsAPIClient(string apiKey, bool isSecure, bool isDebug)
#if !NET20 && !NET35 && !NET40
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public NumbertoWordsAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, NumbertoWordsQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(NumbertoWordsQueryOptions options)
        {
        ...
        public ResponseObj Execute(NumbertoWordsQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(NumbertoWordsQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(NumbertoWordsQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(NumbertoWordsQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(NumbertoWordsQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(NumbertoWordsQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(NumbertoWordsQueryOptions options)
        {
