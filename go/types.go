// Package numbertowords provides a Go client for the Number to Words API.
//
// For more information, visit: https://numbertowords.apiverve.com?utm_source=go&utm_medium=readme
...
// Request contains the parameters for the Number to Words API.
//
// Parameters:
//   - number (required): number - The number to convert to words
type Request struct {
...
// ResponseData contains the data returned by the Number to Words API.
type ResponseData struct {
	...
	AfterDecimal AfterDecimalData `json:"afterDecimal"`
	Locale string `json:"locale"`
}

// AfterDecimalData represents the afterDecimal object.
type AfterDecimalData struct {
