...
const (
	baseURL        = "https://api.apiverve.com/v1/numbertowords"
	defaultTimeout = 30 * time.Second
)

// Client is the Number to Words API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Number to Words API client.
...
// Execute makes a request to the Number to Words API with typed parameters.
//
