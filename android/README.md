...
```gradle
dependencies {
    implementation 'com.github.apiverve:numbertowords-api:1.1.14'
}
```
...
```java
import com.apiverve.numbertowords.NumbertoWordsAPIClient;
import com.apiverve.numbertowords.APIResponse;
import com.apiverve.numbertowords.APIException;

// Initialize the client
NumbertoWordsAPIClient client = new NumbertoWordsAPIClient("YOUR_API_KEY");

try {
    // Prepare query parameters
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("number", 975.07);
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/numbertowords](https://docs.apiverve.com/ref/numbertowords)
...
- **Documentation:** [https://docs.apiverve.com/ref/numbertowords](https://docs.apiverve.com/ref/numbertowords)
- **Issues:** [GitHub Issues](https://github.com/apiverve/numbertowords-api/issues)
